...
The **infographic below** is the result of my work—a visualizatiom of Sea Forward's impact in 2024 that answers an **overarching** **question** with 3 sub-questions:
...
# Save global map ----
ggsave(filename = here::here("images", "sf_map_cedric_code.png"),
       device = "png",
